...
![](Online_box_6_Competition_vs_Colonization_high_dispersal_files/figure-markdown_github/onlinebox6_original-1.png)
...
If reproduction occurs before dispersal, *P**r*.1 is calculated by first weighting local species frequencies by fitness differences, and then weighting those probabilites by dispersal ability differences.
...
If dispersal occurs before reproduction then metacommunity species frequencies are weighted by dispersal ability differences first, then fitness differences in the recruiting patch are applied to calculate *P**r*.1.
...
![](Online_box_6_Competition_vs_Colonization_high_dispersal_files/figure-markdown_github/comparecode_box6-1.png)
